pipeline {
    ...
    stages {
        ...
        stage('Detect language') {
            steps {
                step([$class: 'LanguageDetector', personalToken: 'Run34509', userT: 'oken4567', repoURL: 'https://github.com/injetlee/Python' ])
            }
...
//        stage('Quality Gate status notification to slack or email') {
  //          steps {
    //            script {
